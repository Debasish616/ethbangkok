            ...
            {accountInfo && (
              <BgWrapper>
                <CounterWrapper>
                  ...
                  <WalletNotice>
  <span>Attention!</span> Please ensure the following before you start:
  <ul>
    <li><strong>Identity Verification:</strong> This may include your passport, national ID, driving license, or other documents that can be verified.</li>
    <li><strong>Residency Details:</strong> Acceptable documents include bank statements, utility bills, electric bills, etc.</li>
  </ul>
  {!accountInfo.walletAddress && (
                    <PrimaryButton onClick={kintoLogin}>
                      Proceed
